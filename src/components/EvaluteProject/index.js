...
function EvaluteProjectMain() {
    ...
    return (
        <div>
            ...
            <div className="MainOnEvaluteProject">
                <h1>Chuyên mục</h1>
                <div style={{ width: '90%', height: '1px', backgroundColor: '#e5e5e5', marginBottom: '50px', marginTop: '50px' }}>

                </div>
                <div className="OptionInMainOnEvaluteProject">
                    <div className="OptionInMainOnEvaluteProject1" >
            ...
            <div  className="OptionInMainOnEvaluteProjecth1">
                <h1>Cẩm nang Phân tích đánh giá mới nhất</h1>
            </div>
            <div className="OptionInMainOnEvaluteProject2">
