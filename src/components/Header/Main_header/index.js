...
function Header() {
    ...
    const NVB1 = [
        { name: 'Bán căn hộ chung cư', link: '/ban-can-ho-chung-cu' },
        ...
        <div className="main_nvbar_2">
            <div className="main_nvbar">
                <div style={{ display: "flex" }} className="main_left" >
                    <Link to="/" className="img_12"><img src='https://batdongsan.com.vn/sellernet/static/media/header-logo-sisu.4b76e0ce.svg' className="logo_main"></img><br></br></Link>
